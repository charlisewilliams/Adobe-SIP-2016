...
class BouncingBall(): 
    ...
    def flashBounce(self, screen, colors, screen_width, screen_height,x_speed,y_speed):
...
ball_1 = BouncingBall(150,200,5,3,30)
# -------- Main Program Loop -----------
while not done:
    # --- Main event loop
    ...
    ball_1.flashBounce(screen,possible_ball_colors,700,500,10)
